...
- recursos externos: não há uso de CDN ou imagens remotas no `src/` ou `public/`;
...
- variações de uso criadas: `public/brand/compasso-favicon.svg`, `public/brand/compasso-app-icon.svg`, `public/brand/compasso-navbar.svg`;
